...
/*
    스윙을 이용하여 실행 결과와 같은 모양 GUI 응용프로그램을 작성하라.
    컨텐트팬의 WEST 영역에는 GridLayout 배치 관리자를 사용하여 10개의 버튼을 배치하고,
    CENTER 영역에는 0 ~ 9까지의 정수를 랜덤하게 출력하라.이들은 각각 JLabel 객체를 이용하여 출력하고
    출력되는 좌표의 범위는 (50, 50) ~ (200, 200)이다.
*/

import javax.swing.*;
import java.awt.*;

public class GridLayC extends JFrame {
    public GridLayC() {
        super("West Grid 프레임");
