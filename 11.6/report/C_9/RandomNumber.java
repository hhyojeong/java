...
/*
    숫자가 적힌 12장의 카드(JLabel)가 있고 2개의 카드를 순서대로 클릭하면 두 카드의 번호를 서로
...
public class RandomNumber extends JFrame {
    private JLabel[] cardLabels = new JLabel[12];
    private JLabel firstSelectedLabel = null;

    private final Color defaultColor = Color.YELLOW;
    private final Color selectedColor = new Color(170, 0, 170);
